...
const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const [imagePreview, setImagePreview] = useState<string | undefined>(
    product.filename
      ? `http://localhost:8080/api/v1/image/path/${product.filename}`
      : undefined
  );
        ...
        <form onSubmit={handleSubmit} className="p-8">
          <div className="flex gap-8">
            <div className="flex-1 space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-gray-900 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition-colors"
                  required
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-8 pr-4 py-3 text-gray-900 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition-colors"
                      required
                      placeholder="0"
                    />
                  </div>
            ...
            <div className="w-56 space-y-4">
              <div className="aspect-square w-full bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden">
                {imagePreview ? (
                  <img
                    src={imagePreview}
                    alt="미리보기"
